...
import 'package:enquantum/src/feature/program_content/presentation/viewModel/movimento-circular/movimento-circular-state.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import '../../domain/usecase/calculator.dart';

class MovimentoCircularCubit extends Cubit<MovimentoCircularState> {
  MovimentoCircularCubit() : super(MovimentoCircularState());
